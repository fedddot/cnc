...
RawDataSender::RawDataSender(const std::vector<char>& header, const std::size_t& length_field_size): m_header(header), m_length_field_size(init_length_field_size(length_field_size)) {

}

std::size_t RawDataSender::init_length_field_size(const std::size_t& length_field_size) {
...
std::vector<char> RawDataSender::get_serial_data_length(const std::size_t& data_length) const {
